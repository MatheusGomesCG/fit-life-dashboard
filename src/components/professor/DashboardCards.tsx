    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link 
            to="/cadastrar-aluno"
            className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-150 cursor-pointer"
          >
            <UserPlus className="text-orange-500 h-6 w-6 mb-2" />
            <span className="text-sm text-gray-700 text-center">Novo Aluno</span>
          </Link>
          <Link 
          ...
          >
            ...
            <span className="text-sm text-gray-700 text-center">Novo Treino</span>
          </Link>
          <Link 
            to="/novo-agendamento"
            className="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-150 cursor-pointer"
          >
            ...
            <span className="text-sm text-gray-700 text-center">Agendar</span>
          </Link>
          <Link 
          ...
          >
            ...
            <span className="text-sm text-gray-700 text-center">Relatórios</span>
          </Link>
        </div>
      </div>
    </div>
